...
QT_MOC_LITERAL(1, 8, 18), // "senyalBuscarAlante"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 13) // "slotBtnBuscar"

    },
    "DBuscar\0senyalBuscarAlante\0\0slotBtnBuscar"
};
...
void DBuscar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->senyalBuscarAlante((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->slotBtnBuscar(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DBuscar::senyalBuscarAlante)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DBuscar::senyalBuscarAlante(QString _t1)
{
