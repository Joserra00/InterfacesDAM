/****************************************************************************
** Meta object code from reading C++ file 'dnicio.h'
**
...
#error "The header file 'dnicio.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 26, 16), // "slotCambiarTexto"
QT_MOC_LITERAL(4, 43, 24), // "slotCambiarTextoDenegado"
QT_MOC_LITERAL(5, 68, 14), // "slotActualizar"
QT_MOC_LITERAL(6, 83, 32), // "slotTransferenciaCantidadAceptar"
QT_MOC_LITERAL(7, 116, 18) // "slotTransfCompleta"

    },
    "DInicio\0slotAbrirDialogo\0\0slotCambiarTexto\0"
    "slotCambiarTextoDenegado\0slotActualizar\0"
    "slotTransferenciaCantidadAceptar\0"
    "slotTransfCompleta"
};
...
void DInicio::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->slotCambiarTexto(); break;
        case 2: _t->slotCambiarTextoDenegado(); break;
        case 3: _t->slotActualizar(); break;
        case 4: _t->slotTransferenciaCantidadAceptar((*reinterpret_cast< float(*)>(_a[1]))); break;
        case 5: _t->slotTransfCompleta((*reinterpret_cast< float(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
    }
}
